!function(e, t) {
    ...
    function ScrollSmoother(e) {
        ...
        function ra(e) {
            v.scrollTop = 0,
            F.isInViewport(e.target) || e.target === f || o.scrollTo(e.target, !1, "center center"),
            f = e.target
        }
        function sa(e) {
            var r, n, o, i;
            ...
            (1 !== o || s || l) && (qb(i = F.create({
                ...
                onUpdate: function onUpdate(e) {
                    ...
                    if (e.offset) {
                        ...
                        p.length && !s && p.forEach(function(e) {
                            return e(o - a)
                        }),
                        l ? (l.resetTo("y", o, -w, !0),
                        S && l.progress(1)) : (d.y = o + "px",
                        d.renderTransform(1))
                    }
                }
            })),
        ...
        this.content = function(e) {
            return arguments.length ? (r = M(e || "#smooth-content")[0] || H.children[0],
        ...
        this.wrapper = function(e) {
            return arguments.length ? (v = M(e || "#smooth-wrapper")[0] || function _wrap(e) {
                ...
                return t.classList.add("ScrollSmoother-wrapper"),
        ...
        this.smooth = function(e) {
            return d = e,
            arguments.length ? n.scrubDuration(e) : n.getTween() ? n.getTween().duration() : 0
        }
        ,
